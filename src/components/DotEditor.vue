    ...
    <div v-if="dotEditorData.clone" class="content">
      <div class="container">
        <div class="textSetting">
          ...
          <input v-model.number="dotEditorData.clone.y" type="text" />
        </div>
      </div>
      <div class="save">
        <button @click="saveDot">保存</button>
      </div>
    </div>
    <div v-else class="content">
      <div class="tip">请先绑定节点</div>
    </div>
  </div>
</template>
...
import { dotEditorData, hideDotEditor, saveDot } from 'modules/dot'
</script>
