// // 复用移动音谱/包络的代码
// import { selectedPatternList, contentEditorData, Pattern } from 'modules/pattern'
...
// import { Envelope, selectedEnvelopeList } from 'modules/envelope'
...
//  * @return {null}
//  */
// const moveItem = (e, item, changeStart, changeEnd) => {
...
//     oldPageY = e.pageY,
//     oldPatternData = [], // 修改前的数据
//     oldEnvelopeData = [] // 修改前的数据
//   let difX = 0, // 水平方向上像素差
//     difRow = 0, // 垂直方向上行数差
//     preRow = 0, // 之前的行数差
...
//     needRender = selectedPatternList.has(toRaw(contentEditorData.pattern))
...
//       contentEditorData.pattern = null
